...
install_core() {
    ...
    # Жестко очищаем IP от возможных переносов строк, чтобы не ломать вывод в терминал
...
EOF
    ...
    # СРАЗУ ВЫВОДИМ ССЫЛКИ В КОНСОЛЬ (без пауз и ожиданий)
    ...
    # Больше никакого зависания/ожидания ввода! Скрипт сам продолжит работу.
